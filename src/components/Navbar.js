    ...
    return (
        <div className='d-flex flex-column'>
            <div className='d-flex align-items-center'>
                <Link className='btn me-auto' to='/' onClick={handleBrandClick}><h3 className='fw-bold mb-0'>CS295R - Blog</h3></Link>
                <div className='d-flex align-items-center'>
                    {isHomepage && user ? (
                        <>
                            <Link to='posts/new'>
                    ...
                    {isHomepage ? <button className='btn' onClick={handleLoginClick}>{user ? 'Logout' : 'Login'}</button> : ''}
                </div>
            </div>
